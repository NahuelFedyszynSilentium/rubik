...
class FuturisticCustom<T> extends StatefulWidget {
  ...
  @override
  _FuturisticCustomState<T> createState() => _FuturisticCustomState<T>();
}

class _FuturisticCustomState<T> extends State<FuturisticCustom<T>> {
  Future<T>? _future;
